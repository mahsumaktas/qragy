...
const {
  ...
  loadContentGaps, saveContentGaps, getContentGapReport, pruneContentGaps, handleContentGap, recordContentGap,
...
require("./src/routes/admin").mount(app, {
  ...
  loadContentGaps, saveContentGaps, getContentGapReport, pruneContentGaps, handleContentGap,
